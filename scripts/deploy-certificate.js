...
async function main() {
  try {
    ...
    // Deploy contract - FIXED: Use fully qualified name
    console.log("\n📋 Getting contract factory...");
    console.log("📋 Using contract: contracts/CertificateContract.sol:CertificateContract");
    const CertificateContract = await hre.ethers.getContractFactory("contracts/CertificateContract.sol:CertificateContract");
